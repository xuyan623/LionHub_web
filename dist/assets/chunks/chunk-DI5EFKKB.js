...
var modalGroupLoaders = {
  approval: () => import("./approval-DXERZMS2.js"),
  member: () => import("./member-H6U6NIUQ.js"),
  settings: () => import("./settings-HZEOS4GV.js"),
  task: () => import("./task-AEV3NC2Y.js")
};
...
function loadWorkspaceRuntime() {
  ...
  workspaceRuntimePromise = import("./workspace-runtime-52VIS75O.js").then((module) => {
