...
var routeLoaders = {
  dashboard: () => import("./dashboard-BTH632N4.js"),
  market: () => Promise.resolve({ render: renderMarketPage }),
  myTasks: () => import("./my-tasks-ITWVZKLR.js"),
  taskManagement: () => import("./task-management-S5C33S2E.js"),
  members: () => import("./members-GOGU5B3U.js"),
  projects: () => import("./projects-ZGCM4ONQ.js"),
  rankings: () => import("./rankings-QZNEBBIX.js"),
  reviews: () => import("./reviews-APYRKV6J.js"),
  profile: () => import("./profile-HRSYZA7R.js"),
  settings: () => import("./settings-RIMSGMBM.js")
};
var modalGroupLoaders = {
  approval: () => import("./approval-2GLSWWOJ.js"),
  member: () => import("./member-4P4TTGTV.js"),
  settings: () => import("./settings-H6BMOQAJ.js"),
  task: () => import("./task-OZZWPAZS.js")
};
...
function loadWorkspaceRuntime() {
  ...
  workspaceRuntimePromise = import("./workspace-runtime-SI45ZA6U.js").then((module) => {
