...
var routeLoaders = {
  dashboard: () => import("./dashboard-477LVQTM.js"),
  market: () => import("./market-MGOHOQEL.js"),
  myTasks: () => import("./my-tasks-4T4LGIWJ.js"),
  taskManagement: () => import("./task-management-YSALXU4N.js"),
  members: () => import("./members-VAXFT2KD.js"),
  projects: () => import("./projects-4NYVMUVV.js"),
  rankings: () => import("./rankings-4JSCK6OA.js"),
  reviews: () => import("./reviews-I4XAYDX4.js"),
  profile: () => import("./profile-VALGJHD2.js"),
  settings: () => import("./settings-M3JXUBY4.js")
};
var modalGroupLoaders = {
  approval: () => import("./approval-VYIJUVYS.js"),
  member: () => import("./member-5LHUV4ND.js"),
  settings: () => import("./settings-QATNYKGY.js"),
  task: () => import("./task-5DP7L74L.js")
};
...
function loadWorkspaceRuntime() {
  ...
  workspaceRuntimePromise = import("./workspace-runtime-2YJY3VC6.js").then((module) => {
