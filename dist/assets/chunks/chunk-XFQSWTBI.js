...
var routeLoaders = {
  dashboard: () => import("./dashboard-KQCEM6HK.js"),
  market: () => Promise.resolve({ render: renderMarketPage }),
  myTasks: () => import("./my-tasks-6QF7BM7Y.js"),
  taskManagement: () => import("./task-management-4ALQWM2H.js"),
  members: () => import("./members-FBUQ7X3G.js"),
  projects: () => import("./projects-ZAIBVSSO.js"),
  rankings: () => import("./rankings-VZZ3WVDN.js"),
  reviews: () => import("./reviews-IAFV7WNZ.js"),
  profile: () => import("./profile-2CIJVDOH.js"),
  settings: () => import("./settings-HL2OZCSS.js")
};
var modalGroupLoaders = {
  approval: () => import("./approval-5CZRKZT3.js"),
  member: () => import("./member-NKS42EIF.js"),
  settings: () => import("./settings-2HS2OALB.js"),
  task: () => import("./task-FLQ5UCA3.js")
};
...
function loadWorkspaceRuntime() {
  ...
  workspaceRuntimePromise = import("./workspace-runtime-UVU7QEFD.js").then((module) => {
...
function renderInitializationErrorShell() {
  const secureContextTip = window.isSecureContext ? "\u5F53\u524D\u9875\u9762\u672A\u80FD\u987A\u5229\u8F7D\u5165\uFF0C\u901A\u5E38\u4E0E\u6D4F\u89C8\u5668\u7F13\u5B58\u3001\u7F51\u7EDC\u6CE2\u52A8\u6216\u4E34\u65F6\u540C\u6B65\u5F02\u5E38\u6709\u5173\u3002" : "\u5F53\u524D\u8BBF\u95EE\u65B9\u5F0F\u53EF\u80FD\u53D7\u5230\u6D4F\u89C8\u5668\u9650\u5236\u3002\u8BF7\u4F18\u5148\u4F7F\u7528\u6218\u961F\u63D0\u4F9B\u7684\u6B63\u5F0F\u8BBF\u95EE\u5165\u53E3\uFF0C\u6216\u6539\u7528\u66F4\u7A33\u5B9A\u7684\u8BBF\u95EE\u5730\u5740\u3002";
  return `
...
function renderAuthShell() {
  const hydrationMessage = state.databaseHydrating ? "\u6B63\u5728\u8FDE\u63A5\u6218\u961F\u5171\u4EAB\u6570\u636E\u3002\u767B\u5F55\u6216\u63D0\u4EA4\u6CE8\u518C\u540E\u4F1A\u7EE7\u7EED\u540C\u6B65\u6240\u9700\u5185\u5BB9\u3002" : "\u9996\u6B21\u6253\u5F00\u540E\uFF0C\u767B\u5F55\u6210\u529F\u6216\u63D0\u4EA4\u6CE8\u518C\u65F6\u4F1A\u7EE7\u7EED\u540C\u6B65\u6240\u9700\u5185\u5BB9\u3002";
  return `
    <div class="auth-layout">
      <section class="auth-panel">
        <div class="auth-card glass-card">
...
async function recoverFromPersistenceFailure(error) {
  ...
  pushFlash(
    synchronized ? `\u4FDD\u5B58\u5931\u8D25\uFF0C\u5DF2\u6062\u590D\u5230\u6700\u65B0\u5171\u4EAB\u6570\u636E\uFF1A${message}` : `\u4FDD\u5B58\u5931\u8D25\uFF1A${message}`,
    "info"
  );
}
