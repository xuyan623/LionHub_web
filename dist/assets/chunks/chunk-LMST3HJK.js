...
var routeLoaders = {
  dashboard: () => import("./dashboard-3TQTJHJV.js"),
  market: () => import("./market-6I6BRPX3.js"),
  myTasks: () => import("./my-tasks-CB3QSCYS.js"),
  taskManagement: () => import("./task-management-44MT6ZVL.js"),
  members: () => import("./members-VT7X6SS6.js"),
  projects: () => import("./projects-KF6RRVX4.js"),
  rankings: () => import("./rankings-BNGVWYKY.js"),
  reviews: () => import("./reviews-D6OHS2Q6.js"),
  profile: () => import("./profile-AM3WQ3LX.js"),
  settings: () => import("./settings-N4XGDEEY.js")
};
var modalGroupLoaders = {
  approval: () => import("./approval-UC5RRZ5Z.js"),
  member: () => import("./member-E7PCCVFS.js"),
  settings: () => import("./settings-ZOJJHE64.js"),
  task: () => import("./task-NA4EW5YD.js")
};
...
function loadWorkspaceRuntime() {
  ...
  workspaceRuntimePromise = import("./workspace-runtime-NRVNQONN.js").then((module) => {
