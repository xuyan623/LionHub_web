...
var routeLoaders = {
  dashboard: () => import("./dashboard-AYLTEZ5W.js"),
  market: () => import("./market-MFK2NHMN.js"),
  myTasks: () => import("./my-tasks-MJ4D2SXN.js"),
  taskManagement: () => import("./task-management-Z345ZZHT.js"),
  members: () => import("./members-2RVJ2UUK.js"),
  projects: () => import("./projects-5UTVG3JT.js"),
  rankings: () => import("./rankings-F3QPUAJZ.js"),
  reviews: () => import("./reviews-27UN6XOX.js"),
  profile: () => import("./profile-KDZALY2H.js"),
  settings: () => import("./settings-2BFHZALJ.js")
};
var modalGroupLoaders = {
  approval: () => import("./approval-OOU7DLIO.js"),
  member: () => import("./member-UE7ANELZ.js"),
  settings: () => import("./settings-WDRO4T5S.js"),
  task: () => import("./task-JENN763B.js")
};
...
function loadWorkspaceRuntime() {
  ...
  workspaceRuntimePromise = import("./workspace-runtime-5T6D2NX3.js").then((module) => {
